...
use uuid::Uuid;
use zero2prod_axum_v2::configuration::{DatabaseSettings, get_configuration};
...
/// and retuns its address. (i.e. http://localhost:PORT)
async fn spawn_app() -> TestApp {
    ...
    let server = zero2prod_axum_v2::startup::run(listener, db_pool.clone())
        .await
